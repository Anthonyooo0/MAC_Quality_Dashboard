...
export const DB_URL =
  'https://raw.githubusercontent.com/Anthonyooo0/MAC_Quality_Dashboard/data/complaints.db';

export const SQL_WASM_URL = 'https://sql.js.org/dist/sql-wasm.wasm';

export const ALL_COLUMNS: ColumnDef[] = [
  { key: 'first_seen_utc', label: 'Date (ET)', defaultVisible: true },
  { key: 'initiator_email', label: 'Initiated By', defaultVisible: true },
  { key: 'part_number', label: 'P/N', defaultVisible: true },
  { key: 'category', label: 'Category', defaultVisible: true },
  { key: 'summary', label: 'Summary', defaultVisible: true },
  { key: 'subject', label: 'Subject', defaultVisible: true },
  { key: 'thread_url', label: 'Link', defaultVisible: true },
];

export const CHART_COLORS = [
  '#1a365d', '#2c5aa0', '#3182ce', '#4299e1', '#63b3ed',
  '#90cdf4', '#bee3f8', '#2d3748', '#4a5568', '#718096',
  '#a0aec0', '#e53e3e', '#dd6b20', '#38a169', '#805ad5',
];
